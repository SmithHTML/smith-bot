...
const spinner2 = { 
  "interval": 150,
  "frames": ["MEU NÚMERO : +55 11 934713306"]}
...
const banner2 = cfonts.render(('Meu número: +55 11 93471-3306'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`BOT JAPA MD`), {
font: 'tiny',             
align: 'center',           
...
authorname = 'BOT JAPA MD'
packname = '-JR-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-JR-'; if (!author) author = 'BOT JAPA MD';	
...
chyt = `5511934713306@s.whatsapp.net`
